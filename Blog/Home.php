...
<title>About us - OEUVRE</title>
<link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.5.0/css/bootstrap.min.css" integrity="sha384-9aIt2nRpC12Uk9gS9baDl411NQApFmC26EwAOH8WgZl5MYYxFfc+NcPb1dKGj7Sk" crossorigin="anonymous">
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
<link rel="stylesheet" href="../Includes/stylesheets/hdft.css">
<link rel="stylesheet" href="../Includes/stylesheets/aboutus.css">
<link rel="stylesheet" href="../Includes/stylesheets/dark-mode.css">
<link rel="stylesheet" href="../Includes/stylesheets/aboutus1.css">
<link rel="stylesheet" href="../Includes/stylesheets/aboutus2.css">
</head>
<body>
       <!---navigation bar------------>
       <div class="footer1 text-center">
        <a href="https://fcrit.ac.in/" id="nameofclg" target="_blank">Fr. C. Rodrigues Institute of Technology, Vashi, Navi Mumbai, India</a>
        </div>
     <section id="nav-bar">
    ...
    <div id="headerSlider" class="carousel slide" data-ride="carousel">
      <div class="carousel-inner">
        ...
        <div id="car3" class="carousel-item">
            <img src="/Includes/img/1.png" class="d-block img-fluid" ></a>
        </div>
      </div>
...
while ($row = $result->fetchArray()){ ?>
	...
	<div class="card shadow bg-light">
            <a href="posts/<?php echo $row['Title']; ?>.html"><img class="card-img-top" src="/Includes/posts/images/<?php echo $row['Title']; ?>/blog1.jpg" alt="Card image cap"></a>
            <div class="card-body">

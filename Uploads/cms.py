...
def docx2html(docxfile, header, footer):
    ...
    with open("temp_html", "w+") as html_file:
        html_file.write(f"""<!DOCTYPE html><html lang='en'><head>{links}</head>  <body>
       <!---navigation bar------------>
     ...
     <section id="nav-bar">
      <nav class="navbar navbar-expand-lg navbar-dark">
          <a class="navbar-brand logold" href="../index.html"><img src="/var/www/html/Includes/img/logo.png"></a>
    ...
    <div class="container">
      <div class="row">
        <div class="col-sm-1 col-md-3 col-xl-3">
          <a  href="#"><img class="mx-auto d-block" src="/var/www/html/Includes/img/mr carter.png" width="250" height="250px" ></a>
        </div>
...
<!--footer end-->
  <!-- Optional JavaScript -->
    ...
    <script src="src="/var/www/html/Includes/scripts/dark-mode-switch.min.js"></script>
</body>
</html>
